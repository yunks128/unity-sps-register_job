...
def parse_args():
    ...
    parser.add_argument("--job_id", type=str, default="", help="Job ID of job being executed")
    parser.add_argument("--job_status", type=str, default="", help="Status of job being executed")
    parser.add_argument("--job_inputs", type=str, default="[]", help="JSON array of WPS-T job input objects associated with job")
    parser.add_argument("--job_outputs", type=str, default="[]", help="JSON array of WPS-T job output objects associated with job")
    parser.add_argument("--tags", type=str, default="{}", help="JSON array of WPS-T job output objects associated with job")
